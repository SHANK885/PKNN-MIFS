...
def featureClassCorrelation(X, y, m, d):
        
    # Compute Feature Class Mutual Information
    FCMI = mutual_info_classif(X, 
                               y,
                               discrete_features = 'auto', 
                               n_neighbors = 3,
                               copy = True,
    ...
    print("Feature Class Correlation Computed-----------------------------------")
    print("")
    # Return Feature Class Mutual Information
    return FCMI.reshape(d, 1)
